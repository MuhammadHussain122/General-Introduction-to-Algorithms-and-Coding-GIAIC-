...
async function checkNumberIsPositiveOrNegative() {
    ...
    if (inputNumber.userInputNumber > 0) {
        console.log(chalk.green(`${inputNumber.userInputNumber} is a positive number`));
    }
    else if (inputNumber.userInputNumber < 0) {
        console.log(chalk.green(`${inputNumber.userInputNumber} is a negative number`));
    }
    else if (inputNumber.userInputNumber === 0) {
        console.log(chalk.green(`${inputNumber.userInputNumber} is neither a positive nor a negative number`));
    }
    else {
...
async function checkNumberAgain() {
    ...
    } while (inputNumAgain.inputNum === "y" ||
