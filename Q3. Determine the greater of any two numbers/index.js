...
async function getGreaterNumber() {
    ...
    if (inputNumbers.num1 > inputNumbers.num2) {
        console.log(chalk.green(`${inputNumbers.num1} is greater than ${inputNumbers.num2}`));
    }
    else if (inputNumbers.num2 > inputNumbers.num1) {
        console.log(chalk.green(`${inputNumbers.num2} is greater than ${inputNumbers.num1}`));
    }
    else if (inputNumbers.num1 === inputNumbers.num2) {
        console.log(chalk.green(`${inputNumbers.num1} is equal to ${inputNumbers.num2}`));
    }
    else {
...
async function getGreaterNumberAgain() {
    ...
    } while (inputAgain.inputNumbersAgain === "y" ||
